...
class Consensus(Map):
    ...
    def map(self, mps, losses, norms):
        ...
        gammaJTF_dis = [self.m.params['gamma']*g for g in norm_dis_grad]
        gammaJTF_lat_dis = [self.m.params['gamma']*g for g in norm_lat_grad_dis]
        ...
        gammaJTF_lat_gan = [self.m.params['gamma']*g for g in norm_lat_grad_gan]
